...
def test_baseline_fusion_model_rejects_lidar_channel_override_that_conflicts_with_mode_contract():
    with pytest.raises(ValueError, match="lidar_channels must match enriched mode"):
        BaselineFusionModel(lidar_mode="enriched", lidar_channels=7, output_dim=4)
